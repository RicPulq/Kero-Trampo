...
class PostAcademicProfiles(BaseModel):
    education_instution: str | None = Field(description='Nome da Instituição de Ensino', max_length=255)
    campus_name: str | None = Field(description='Nome do Campus', max_length=255)
    ...
    academic_coefficient: float | None = Field(description='Coeficiente Acadêmico, favor transformar em inteiro de 0 a 100')
